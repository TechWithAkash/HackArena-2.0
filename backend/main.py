...
from backend.routes import health_data, risk, simulate, insights, recommend, alerts, chat, memory, telegram as telegram_route, arena, profile
...
app = FastAPI(
    title="DarpanAI",
    description="Cognitive Health Twin — Dynamic Analysis and Replica for Predicting Actionable Needs using AI",
    version="1.0.0",
    lifespan=lifespan,
)
...
async def health_check():
    return {"status": "ok", "service": "DarpanAI"}
