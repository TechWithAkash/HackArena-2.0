...
export default function RecommendPage() {
  ...
  const userId = typeof window !== "undefined"
    ? (sessionStorage.getItem("darpan_user_id") ?? DEFAULT_USER)
    : DEFAULT_USER;
          ...
          <div className="space-y-10">
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-[11px] font-bold text-gray-400 uppercase tracking-widest mt-0.5">
                  Ranked by causal impact · DarpanEnsemble v2
                </p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3 pt-6 border-t border-gray-100">
              <div className="flex-1 text-xs text-gray-400 font-medium">
                Generated by Groq LLaMA-3 · DarpanEnsemble v2 · {new Date().toLocaleDateString("en-US", { month: "long", day: "numeric", year: "numeric" })}
              </div>
              <button
                onClick={() => router.push("/dashboard")}
